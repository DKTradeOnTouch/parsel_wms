...
Future<Either<GetSalesOrderListByStatusModel, Exception>> fetchInProgressSkuApi(
  ...
  Either<dynamic, Exception> getSalesOrderListByStatusApi =
    ...
    context,
    url:
        '${APIUtilities.getSalesOrderListByStatus}/?status=ON_GOING&driverId=$userId&date=${DateFormat('yyyy-MM-dd').format((DateTime.now()))}',
