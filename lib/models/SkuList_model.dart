...
//
//     final skuListModel = skuListModelFromJson(jsonString);

import 'dart:convert';

SkuListModel skuListModelFromJson(String str) =>
    SkuListModel.fromJson(json.decode(str));
