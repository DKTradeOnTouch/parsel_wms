...
import 'packing_list_detail_page.dart';
...
class PackingList extends StatefulWidget {
  ...
  Data? data;
  PackingList({Key? key, this.resultList, required this.data, this.itemList})
      : super(key: key);
            ...
            children: [
              InkWell(
                onTap: () {
                  ...
                  print('SKU COUNT-->' + widget.itemList!.length.toString());
