...
class PickingSkuListItem extends StatefulWidget {
  List<pl.ItemList> itemList;
  PickingSkuListItem({Key? key, required this.itemList}) : super(key: key);

  @override
  State<PickingSkuListItem> createState() => _PickingSkuListItemState();
}
...
class _PickingSkuListItemState extends State<PickingSkuListItem> {
  int index = 0;
